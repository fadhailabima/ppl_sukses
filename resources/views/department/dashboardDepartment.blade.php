...
<body style="background-color:#bfdeeb">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="/dashboarddosen/khs" class="nav-link text-dark"><b> Data KHS Mahasiswa</b></a>
            </li>
            ...
            <li class="nav-item"><a href="/dashboarddosen/skripsi" class="nav-link text-dark"><b>Data Mahasiswa
                        Skripsi</b></a></li> --}}
            <li class="nav-item"><a href="/dashboarddepartment/daftarmahasiswa" class="nav-link text-dark"><b>Data Mahasiswa</b></a></li>
        </ul>
                ...
                <div class="col-6" style="margin-top: 50px;">
                    <div class="grid grid-cols-2 gap-4 mb-3">
                        <div class="col-12" style="margin-top: 15px;">
                            <div class="ms-3">{{ auth()->user()->departemen->nama_department }}</div>
                            {{-- <div class="ms-3">{{ auth()->user()->departemen->nip }}</div> --}}
                            <div class="ms-3">{{ auth()->user()->departemen->email }}</div>
