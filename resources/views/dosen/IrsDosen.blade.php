...
<body style="background-color:#bfdeeb">
    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="/dashboarddosen/irs" class="nav-link active" aria-current="page"
                    style="background-color:#101E31"><b> Data IRS
                        Mahasiswa</b></a></li>
        ...
        <div class="flex flex-col mt-6">
            {{-- <div class="container justify-content-center text-center text-bold">
                <h6>Isian Rencana Studi (IRS) Mahasiswa Perwalian</h6>
            </div> --}}
