...
@section('profil')
    ...
    <div class="mr-2 ">
        <span
            class="dark:hover:text-primary hover:text-primary transition-colors duration-200 ease-in-out text-[1.075rem] font-medium dark:text-neutral-400/90 text-secondary-inverse">{{ auth()->user()->dosenWali->nama }}</a>
            <span
                class="text-secondary-dark dark:text-stone-500 font-medium block text-[0.85rem]">{{ auth()->user()->dosenWali->nip }}</span>
            <span
                class="text-secondary-dark dark:text-stone-500 font-medium block text-[0.85rem]">{{ auth()->user()->dosenWali->email }}</span>
            ...
            <div class="container mt-2" style="margin-top: 32px;">
                ...
                <div class="row mt-3 justify-content-md-left">
                    <img src="{{ asset('storage/photo/' . $mahasiswa->foto_mahasiswa) }}"
                        class="rounded-circle img-thumbnail" style="height: 120px; width: 120px;">
                    <div class="col-sm-2">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="tab-content" id="semesterTabsContent">
                                            @if ($irsData && $khsData)
                                                <div class="tab-pane fade show active" id="irsTab_{{ $semester }}"
                                                    role="tabpanel">
                                                    <p>Semester {{ $semester }}</p>
                                                    <p>{{ $irsData->jmlsks }} SKS</p>
                                                </div>
                                                <div class="tab-pane fade" id="khsTab_{{ $semester }}" role="tabpanel">
                                            ...
                                            @if ($pklData)
                                                <div class="tab-pane fade" id="pklTab_{{ $semester }}" role="tabpanel">
                ...
                <div class="row">
                    <div class="text-left mt-2">
                        ...
                        <div class="font-medium text-base flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" stroke="red"
                        ...
                        <div class="font-medium text-base flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" stroke="blue"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <div class="font-medium text-base flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" stroke="yellow"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <div class="font-medium text-base flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" stroke="green"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
