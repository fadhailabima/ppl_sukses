                ...
                <div class="col-7" style="margin-top: 32px;">
                    <div class="row">
                        ...
                        <div class="col-6 ml-52 mt-4">
                            <div class="ms-3" style="font-size: 16px;">{{ auth()->user()->mahasiswa->nama }}</div>
                            <div class="ms-3" style="font-size: 16px;">{{ auth()->user()->mahasiswa->nim }}</div>
                            <div class="ms-3" style="font-size: 16px;">{{ auth()->user()->mahasiswa->angkatan }}</div>
                            <div class="ms-3" style="font-size: 16px;">{{ auth()->user()->mahasiswa->email }}</div>
                            <br>
                        </div>
                    </div>
                </div>
