...
<div class="mt-2 bg-white p-2 shadow rounded-lg">
    <h2 class="text-gray-500 text-lg font-semibold pb-1">Isi Data IRS</h2>
    ...
    <div class="text-base">
        ...
        <form class="user justify-content-md-center flex-column align-items-center" method="POST" action="/dashboardmahasiswa/IsiIRSMahasiswa"
            ...
            <div class="row justify-content-md-center mb-2">
                <label for="jmlsks" class="col-sm-2 col-form-label">Jumlah SKS :<sup
                        class="text-danger">*</sup></label>
                <div class="col-sm-2">
                    <input type="text" class="form-control  @error('jmlsks')
                    is-invalid    
                    @enderror" id="jmlsks" name="jmlsks" placeholder="Jumlah SKS" required
                        value="{{ old('jmlsks') }}">
                    @error('jmlsks')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="row justify-content-md-center mb-4">
                <label for="scansks" class="col-sm-2 col-form-label">Scan KRS :<sup
                        class="text-danger">*</sup></label>
                <div class="col-sm-2">
                    <input type="file" class="form-control  @error('scansks') is-invalid @enderror" id="scansks" name="scansks" placeholder="Scan SKS" required>
                    @error('scansks')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
