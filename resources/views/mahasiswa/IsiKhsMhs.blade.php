                ...
                <div class="col-sm mt-5">
                    ...
                    <form class="user" method="POST" action="/dashboardmahasiswa/IsiKHSMahasiswa"
                        ...
                        <div class="mb-3 row mt-1">
                            ...
                            <div class="mb-3 row">
                                <label for="skssemester" class="col-sm-4 col-form-label">SKS Semester :<sup
                                        class="text-danger">*</sup></label>
                            ...
                            <div class="mb-3 row">
                                <label for="ipsemester" class="col-sm-4 col-form-label">IP Semester :<sup
                                        class="text-danger">*</sup></label>
                                <div class="col-sm-6 ml-2">
                                    <input type="text"
                            ...
                            <div class="mb-3 row">
                                <label for="skskumulatif" class="col-sm-4 col-form-label">SKS Kumulatif :<sup
                                        class="text-danger">*</sup></label>
                                <div class="col-sm-6 ml-2">
                                    <input type="text"
                            ...
                            <div class="mb-3 row">
                                <label for="ipkumulatif" class="col-sm-4 col-form-label">IP Kumulatif :<sup
                                        class="text-danger">*</sup></label>
                                <div class="col-sm-6 ml-2">
                                    <input type="text"
                            ...
                            <div>
                                ...
                                <div class="col-sm d-flex justify-content-center">
                                    ...
                                    is-invalid    
                                    @enderror"
                                            id="scankhs" name="scankhs" placeholder="Scan KHS" required>
                                        @error('scankhs')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
