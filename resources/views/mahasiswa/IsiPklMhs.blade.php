...
<div class="mt-2 bg-white p-2 shadow rounded-lg">
    <h2 class="text-gray-500 text-lg font-semibold pb-1">Isi Data PKL</h2>
    ...
    <div class="text-base">
        ...
        @endif
        <form class="user justify-content-md-center flex-column align-items-center" method="POST" action="/dashboardmahasiswa/IsiPKLMahasiswa"
            ...
            <div class="row justify-content-md-center mb-2">
                <label for="instansi" class="col-sm-2 col-form-label">Instansi :<sup
                        class="text-danger">*</sup></label>
                <div class="col-sm-2">
                    <input type="text" class="form-control  @error('instansi')
                    is-invalid    
                    @enderror" id="instansi" name="instansi" placeholder="Instansi" required
                        value="{{ old('instansi') }}">
                    @error('instansi')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="row justify-content-md-center mb-2">
                <label for="dosenpengampu" class="col-sm-2 col-form-label">Dosen Pengampu :<sup
                        class="text-danger">*</sup></label>
                <div class="col-sm-2">
                    <select class="form-control @error('dosenpengampu') is-invalid @enderror " name="dosenpengampu" id="dosenpengampu" required>
            ...
            <div class="row justify-content-md-center mb-4">
                <label for="scanpkl" class="col-sm-2 col-form-label">Scan Berkas PKL :<sup
                        class="text-danger">*</sup></label>
                <div class="col-sm-2">
                    <input type="file" class="form-control  @error('scanpkl') is-invalid @enderror" id="scanpkl" name="scanpkl" placeholder="Scan Berkas PKL" required>
                    @error('scanpkl')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
