    ...
    <div class="me-5 ms-5">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="#" class="nav-link active" aria-current="page"
                    style="background-color:#101E31"><b>Data Skripsi</b></a></li>
        </ul>
        <div class="container mt-4 flex justify-center items-center">
            <h2 class="text-4xl text-center">Isi Data Skripsi</h2>
        </div>
        ...
        <div class="container bg-white rounded-2xl max-w-screen-sm">
            <div class="row">
                ...
                <div class="col-sm mt-5">
                    ...
                    <form class="user" method="POST" action="/dashboardmahasiswa/IsiSkripsiMahasiswa"
                        ...
                        <div class="mb-3 row mt-1">
                            ...
                            <div class="mb-3 row">
                                <label for="tglsidang" class="col-sm-4 col-form-label">Tanggal Sidang :<sup
                                        class="text-danger">*</sup></label>
                                <div class="col-sm-6 ml-2">
                                    ...
                                    is-invalid    
                                    @enderror"
                                        id="tglsidang" name="tglsidang" placeholder="tglsidang" required
                                        value="{{ old('tglsidang') }}">
                                    @error('tglsidang')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="mb-3 row">
                                <label for="dosenpembimbing" class="col-sm-4 col-form-label">Dosen Pemb :<sup
                                        class="text-danger">*</sup></label>
                                <div class="col-sm-6 ml-2">
                                    <select
                ...
                @enderror mb-3"
                            ...
                            <div>
                                <h2>Upload Berita Acara Sidang</h2>
                                <div class="col-sm d-flex justify-content-center">
                                    ...
                                    is-invalid    
                                    @enderror"
                                            id="scansidang" name="scansidang" placeholder="Scan Sidang" required>
                                        @error('scansidang')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
