...
@section('konten')
    <div class="mt-2 flex flex-wrap space-x-0 space-y-2 md:space-x-4 md:space-y-0">
        <div class="flex-1 bg-white p-2 shadow rounded-lg md:w-1/3">
            <h2 class="text-gray-500 text-lg font-semibold pb-1">Daftar Mahasiswa Sudah Lulus Skripsi</h2>
            ...
            <div>
                <a href="/dashboardadmin/rekapskripsi"
                    ...
                    target="">Kembali</a>
                <a href="{{ route('listSudahSkripsioperator.pdf', ['tahun' => $tahun]) }}"
                    class="text-white bg-blue-500 hover:bg-blue-600 font-medium text-base text-center py-2 px-4 rounded-full"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        @foreach ($skripsis as $item)
                            <tr>
                                ...
                                <td class="px-4 py-4">{{ $item->dosenpembimbing }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
