...
<body style="background-color:#bfdeeb">
    <nav class=" navbar navbar-expand-lg navbar-light text-light" style="background-color:#083c7859; box-shadow: 2px 0px rgb(69, 67, 67);">
        ...
        <ul class="nav nav-pills justify-content-center text-dark">
            ...
            <li class="nav-item"><a href="#" class="nav-link active" aria-current="page" style="background-color:#101E31"><b>Register User</b></a></li>
            <li class="nav-item"><a href="" class="nav-link text-dark"><b>Edit Berkas</b></a></li>
            <li class="nav-item"><a href="" class="nav-link text-dark"><b>Lihat User</b></a></li>
        </ul>
        <br>
        <div class="container d-flex justify-content-center">
            <div class="card rounded-2xl max-w-screen-lg" style="width: 40rem;" style="box-shadow: 2px 2px rgb(69, 67, 67);">
                    ...
                    <div class="col-md-auto" style="margin-bottom: 10px;">
                        <form action="/dashboardadmin/register" method="POST" >
                            ...
                            <div class="mb-1 row mt-3">
                                <label for="name" class="col-sm-4 col-form-label">Nama<sup class="text-danger">*</sup></label>
                                ...
                                <label for="email" class="col-sm-4 col-form-label">E-Mail<sup class="text-danger">*</sup> </label>
                                <div class="form-group col-sm-8">
                            ...
                            <div class="mb-1 row">
                                <label for="nim" class="col-sm-4 col-form-label">NIM<sup class="text-danger">*</sup> </label>
                                <div class="form-group col-sm-8">
                                    <input type="text" name="nim" class="form-control mb-2     @error('nim') is-invalid @enderror"
                                        id="nim" placeholder="NIM User" required value="{{ old('nim') }}">
                                    @error('nim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-1 row">
                                <label for="jurusan" class="col-sm-4 col-form-label">Jurusan<sup class="text-danger">*</sup></label>
                                <div class="form-group col-sm-8">
                                    <input type="text" class="form-control mb-2 @error('jurusan') is-invalid @enderror" id="jurusan" name="jurusan" placeholder="Jurusan User" required value="{{ old('jurusan') }}">   
                                    @error('jurusan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-1 row">
                                <label for="angkatan" class="col-sm-4 col-form-label">Angkatan<sup class="text-danger">*</sup></label>
                                <div class="form-group col-sm-8">
                                    <input type="text" class="form-control mb-2 @error('angkatan') is-invalid @enderror" 
                                        id="angkatan" name="angkatan" placeholder="Angkatan User" required value="{{ old('angkatan') }}">
                                    @error('angkatan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-1 row">
                                <label for="dosenwali" class="col-sm-4 col-form-label">Dosen Wali <br>(jika user mahasiswa)<sup class="text-danger">*</sup></label>
                                <div class="form-group col-sm-8 mt-2">
                                    <select
                                        ...
                                        <option value="Prabowo Nur Khalid">Nurdin Bahtiar</option>
                                        <option value="Yos Sudarso">Adi Wibowo</option>
                                        <option value="Arum Ningtyas">Aris Puji</option>
                                        <option value="Fajar Wulandari">Prajanto Wahyu</option>
                                        <option value="Nurul Rini">Beta Noranita</option>
                                        <option value="Mila Kartika Cantika">Adhe Setya</option>
                                        <option value="Aji Eko Kurniawan">Malik Hakim</option>
                                    </select>
                                    @error('dosenwali')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="mb-1 row">
                                <label for="level" class="col-sm-4 col-form-label">Level User<sup class="text-danger">*</sup></label>
                                <div class="form-group col-sm-8">
                                    <select
                                        class="form-control mb-2 @error('level') is-invalid @enderror" name="level" id="level" required>
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="form-group col-sm-8">
                                    <input type="password" class="form-control mb-2 @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password User" required>   
                                    @error('password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
